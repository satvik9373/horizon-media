! function() {
    ...
    window.swv = {
        validators: b,
        validate: (f, g, h = {}) => {
            const e = (f.rules ? ? []).filter(({
                rule: a,
                ...c
            }) => "function" == typeof b[a] && ("function" != typeof b[a].matches || b[a].matches(c, h)));
            ...
            const c = new n(g),
                d = e.reduce((d, g) => {
                    ...
                    if (d.get(e.field) ? .error) return d;
                    try {
                        b[f].call({
                            rule: f,
                            ...e
                        ...
                        if (b instanceof a) return d.set(e.field, b)
                    }
                    return d
                }, new Map);
            for (const a of c.keys()) d.has(a) || d.set(a, {
