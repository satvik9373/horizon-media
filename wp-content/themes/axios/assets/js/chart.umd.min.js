...
! function(t, e) {
    ...
    const _t = (t, e, i) => Math.max(Math.min(t, i), e);

    function yt(t) {
        return _t(xt(2.55 * t), 0, 255)
    }

    function vt(t) {
        return _t(xt(255 * t), 0, 255)
    }

    function Mt(t) {
        return _t(xt(t / 2.55) / 100, 0, 1)
    }

    function wt(t) {
        return _t(xt(100 * t), 0, 100)
    }
    const kt = {
            0: 0,
            1: 1,
        ...
        St = [..."0123456789ABCDEF"],
        Pt = t => St[15 & t],
        Dt = t => St[(240 & t) >> 4] + St[15 & t],
        Ct = t => (240 & t) >> 4 == (15 & t);

    function Ot(t) {
        var e = (t => Ct(t.r) && Ct(t.g) && Ct(t.b) && Ct(t.a))(t) ? Pt : Dt;
        return t ? "#" + e(t.r) + e(t.g) + e(t.b) + ((t, e) => t < 255 ? e(t) : "")(t.a, e) : void 0
    }
    const At = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
    ...
    function It(t, e, i, s) {
        return (Array.isArray(e) ? t(e[0], e[1], e[2]) : t(e, i, s)).map(vt)
    }
    ...
    function Ht(t) {
        Wt || (Wt = function() {
            ...
            for (s = 0; s < e.length; s++) {
                for (a = r = e[s], n = 0; n < i.length; n++) o = i[n], r = r.replace(o, Bt[o]);
    ...
    const $t = t => t <= .0031308 ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - .055,
        Yt = t => t <= .04045 ? t / 12.92 : Math.pow((t + .055) / 1.055, 2.4);

    function Ut(t, e, i) {
        if (t) {
            let s = Rt(t);
            s[e] = Math.max(0, Math.min(s[e] + s[e] * i, 0 === e ? 360 : 1)), s = zt(s), t.r = s[0], t.g = s[1], t.b = s[2]
        }
    }
    ...
    function Kt(t) {
        return "r" === t.charAt(0) ? function(t) {
            ...
            if (e) {
                if (e[7] !== i) {
                    const t = +e[7];
                    o = e[8] ? yt(t) : _t(255 * t, 0, 255)
                }
                return i = +e[1], s = +e[3], n = +e[5], i = 255 & (e[2] ? yt(i) : _t(i, 0, 255)), s = 255 & (e[4] ? yt(s) : _t(s, 0, 255)), n = 255 & (e[6] ? yt(n) : _t(n, 0, 255)), {
                    r: i,
                    g: s,
                    b: n,
                    a: o
    ...
    class Gt {
        constructor(t) {
            ...
            let i;
            var s, n, o;
            "object" === e ? i = qt(t) : "string" === e && (o = (s = t).length, "#" === s[0] && (4 === o || 5 === o ? n = {
                r: 255 & 17 * kt[s[1]],
                g: 255 & 17 * kt[s[2]],
                b: 255 & 17 * kt[s[3]],
                a: 5 === o ? 17 * kt[s[4]] : 255
                ...
                g: kt[s[3]] << 4 | kt[s[4]],
                b: kt[s[5]] << 4 | kt[s[6]],
                a: 9 === o ? kt[s[7]] << 4 | kt[s[8]] : 255
            })), i = n || Ht(t) || Kt(t)), this._rgb = i, this._valid = !!i
        }
        get valid() {
            return this._valid
        }
        ...
        interpolate(t, e) {
            return t && (this._rgb = function(t, e, i) {
                const s = Yt(Mt(t.r)),
                    ...
                    o = Yt(Mt(t.b));
                return {
                    r: vt($t(s + i * (Yt(Mt(e.r)) - s))),
                    g: vt($t(n + i * (Yt(Mt(e.g)) - n))),
                    b: vt($t(o + i * (Yt(Mt(e.b)) - o))),
                    a: t.a + i * (e.a - t.a)
                }
        ...
        rotate(t) {
            return function(t, e) {
                var i = Rt(t);
                i[0] = Ft(i[0] + e), i = zt(i), t.r = i[0], t.g = i[1], t.b = i[2]
            }(this._rgb, t), this
        }
    }
    ...
    function te(t) {
        return Jt(t) ? t : Zt(t).saturate(.5).darken(.1).hexString()
    }
    ...
    const oe = {
        ...
        logarithmic(t, e, i) {
            if (0 === t) return "0";
            const s = i[e].significand || t / Math.pow(10, Math.floor(I(t)));
    ...
    function ce(t, e, i) {
        return "string" == typeof e ? m(he(t, e), i) : m(he(t, ""), e)
    }
    class de {
        constructor(t, e) {
    ...
    function Me(t, e, i, s) {
        const n = me(t),
            o = _e(n, "margin"),
            a = pe(n.maxWidth, t, "clientWidth") || A,
            r = pe(n.maxHeight, t, "clientHeight") || A,
            l = function(t, e, i) {
                let s, n;
        ...
        h = Math.max(0, h - o.width), c = Math.max(0, s ? Math.floor(h / s) : c - o.height), h = ve(Math.min(h, a, l.maxWidth)), c = ve(Math.min(c, r, l.maxHeight)), h && !c && (c = ve(h / 2));
        return (void 0 !== e || void 0 !== i) && s && l.height && c > l.height && (c = l.height, h = ve(Math.floor(c * s))), {
            width: h,
            height: c
        }
    }
    ...
    function Ce(t, e, i, n) {
        ...
        let h, c, d, u, f;
        for (h = 0; h < l; h++)
            if (u = i[h], null != u && !0 !== s(u)) r = De(t, o, a, r, u);
            else if (s(u))
            for (c = 0, d = u.length; c < d; c++) f = u[c], null == f || s(f) || (r = De(t, o, a, r, f));
        t.restore();
        const g = a.length / 2;
        if (g > i.length) {
    ...
    function Le(t, e, i, s, n) {
        ...
        if (!(isNaN(p) || p <= 0)) {
            switch (t.beginPath(), f) {
                default: n ? t.ellipse(i, s, n / 2, p, 0, 0, C) : t.arc(i, s, p, 0, C),
                t.closePath();
                break;
                case "triangle":
                        c = n ? n / 2 : p,
                ...
                case "rectRounded":
                    ...
                    l = p - h,
                    a = Math.cos(m + E) * l,
                    d = Math.cos(m + E) * (n ? n / 2 - h : l),
                    r = Math.sin(m + E) * l,
                    u = Math.sin(m + E) * (n ? n / 2 - h : l),
                    t.arc(i - d, s - r, h, m - D, m - L),
                    t.arc(i + u, s - a, h, m - L, m),
                    t.arc(i + d, s + r, h, m, m + L),
                    t.arc(i - u, s + a, h, m + L, m + D),
                    t.closePath();
                    break;
                case "rect":
                        if (!g) {
    ...
    function Ve(t, e, n, o, a, r = {}) {
        ...
        for (t.save(), t.font = a.string, function(t, e) {
            ...
            }(t, r), c = 0; c < l.length; ++c) d = l[c], r.backdrop && Ne(t, r.backdrop), h && (r.strokeColor && (t.strokeStyle = r.strokeColor), i(r.strokeWidth) || (t.lineWidth = r.strokeWidth), t.strokeText(d, n, o, r.maxWidth)), t.fillText(d, n, o, r.maxWidth), Be(t, n, o, d, r), o += a.lineHeight;
        t.restore()
    }
    ...
    function He(t, e = [""], i = t, s, n = (() => t[0])) {
        ...
        return new Proxy(o, {
            ...
            get: (i, s) => Xe(i, s, (() => function(t, e, i, s) {
                let n;
                for (const o of e)
                    if (n = Qe(Ye(o, t), i), w(n)) return Ue(t, n) ? Ze(i, s, t, n) : n
            }(s, e, t, i))),
    ...
    function je(t, e, i, o) {
        const a = {
            ...
            _stack: new Set,
            _descriptors: $e(t, o),
            setContext: e => je(t, e, i, o),
            override: s => je(t.override(s), e, i, o)
        };
        return new Proxy(a, {
    ...
    const Ye = (t, e) => t ? t + M(e) : e,
        Ue = (t, e) => n(e) && "adapters" !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
    ...
    const Ke = (t, e) => !0 === t ? e : "string" == typeof t ? v(e, t) : void 0;
    ...
    function Ze(t, e, i, o) {
        const a = e._rootScopes,
            r = qe(e._fallback, i, o),
            l = [...t, ...a],
            h = new Set;
        h.add(o);
        let c = Je(h, l, i, r || i, o);
        return null !== c && ((!w(r) || r === i || (c = Je(h, l, r, c, o), null !== c)) && He(Array.from(h), [""], a, r, (() => function(t, e, i) {
    ...
    function ai(t, e = "x") {
        ...
        for (a = 0; a < s; ++a)
            ...
            for (let c = 0; c < s - 1; ++c) l = h, h = si(t, c + 1), l && h && (F(e[c], 0, ii) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c], o = i[c + 1] / e[c], r = Math.pow(n, 2) + Math.pow(o, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[c] = n * a * e[c], i[c + 1] = o * a * e[c])))
        }(t, n, o),
        function(t, e, i = "x") {
            const s = ni(i),
                n = t.length;
    ...
    function li(t, e, i, s, n) {
        ...
        e.capBezierPoints && function(t, e) {
            ...
            for (i = 0, s = t.length; i < s; ++i) a = o, o = r, r = i < s - 1 && Ee(t[i + 1], e), o && (n = t[i], a && (n.cp1x = ri(n.cp1x, e.left, e.right), n.cp1y = ri(n.cp1y, e.top, e.bottom)), r && (n.cp2x = ri(n.cp2x, e.left, e.right), n.cp2y = ri(n.cp2y, e.top, e.bottom)))
        }(t, i)
    }
    const hi = t => 0 === t || 1 === t,
        ci = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * C / i),
        di = (t, e, i) => Math.pow(2, -10 * t) * Math.sin((t - e) * C / i) + 1,
        ui = {
            linear: t => t,
            easeInQuad: t => t * t,
            easeOutQuad: t => -t * (t - 2),
    ...
    function ki(t, e) {
        ...
        const n = {
            ...
            lineHeight: _i(r(t.lineHeight, e.lineHeight), i),
            size: i,
            style: s,
    ...
    function Ei(t, e, i) {
        ...
        const y = () => x || l(n, b, p) && 0 !== r(n, b),
            v = () => !x || 0 === r(o, p) || l(o, b, p);
        for (let t = c, i = c; t <= d; ++t) m = e[t % a], m.skip || (p = h(m[s]), p !== b && (x = l(p, n, o), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(Li({
            start: _,
            end: t,
            loop: u,
            count: a,
            ...
            for (const t of e) {
                ...
                for (u = d + 1; u <= t.end; u++) {
                    ...
                    e = Fi(s.setContext(Di(n, {
                        ...
                        p1DataIndex: u % l,
                        datasetIndex: a
                    }))), Vi(e, c) && f(d, u - 1, t.loop, c), o = r, c = e
                }
    ...
    var Bi = Object.freeze({
        ...
        _isBetween: Q,
        getRtlAdapter: Ci,
        overrideTextDirection: Oi,
        restoreTextDirection: Ai,
        _boundSegment: Ei,
        _boundSegments: Ri,
        _computeSegments: Ii
    });
    ...
    function Hi(t, e, i, s, n) {
        ...
        return Wi(t, i, e, (function(i, a, r) {
    ...
    function ji(t, e, i, s, n, o) {
        ...
        return Wi(t, i, e, (function(i, h, c) {
    ...
    function $i(t, e, i, s, n, o) {
        return o || t.isPointInArea(e) ? "r" !== i || s ? ji(t, e, i, s, n, o) : function(t, e, i, s) {
            let n = [];
            return Wi(t, i, e, (function(t, i, o) {
                const {
                    startAngle: a,
                    endAngle: r
        ...
        modes: {
            index(t, e, i, s) {
                const n = ye(e, t),
                    ...
                    r = i.intersect ? Hi(t, n, o, s, a) : $i(t, n, o, !1, s, a),
                    l = [];
            ...
            dataset(t, e, i, s) {
                const n = ye(e, t),
                    o = i.axis || "xy",
                    a = i.includeInvisible || !1;
                let r = i.intersect ? Hi(t, n, o, s, a) : $i(t, n, o, !1, s, a);
                if (r.length > 0) {
            ...
            point: (t, e, i, s) => Hi(t, ye(e, t), i.axis || "xy", s, i.includeInvisible || !1),
            nearest(t, e, i, s) {
                const n = ye(e, t),
                    o = i.axis || "xy",
                    a = i.includeInvisible || !1;
                return $i(t, n, o, i.intersect, s, a)
            },
            x: (t, e, i, s) => Yi(t, ye(e, t), "x", i.intersect, s),
            y: (t, e, i, s) => Yi(t, ye(e, t), "y", i.intersect, s)
        }
    };
    ...
    function ts(t, e, i, s) {
        ...
        a.getPadding && Qi(r, a.getPadding());
        const l = Math.max(0, e.outerWidth - Ji(r, t, "left", "right")),
            h = Math.max(0, e.outerHeight - Ji(r, t, "top", "bottom")),
            c = l !== t.w,
            d = h !== t.h;
    ...
    function is(t, e, i, s) {
        ...
        for (o = 0, a = t.length, h = 0; o < a; ++o) {
            r = t[o], l = r.box, l.update(r.width || e.w, r.height || e.h, es(r.horizontal, e));
            const {
                same: a,
                other: d
            } = ts(e, i, r, s);
    ...
    function ns(t, e, i, s) {
        ...
        for (const r of t) {
            ...
            if (r.horizontal) {
                const s = e.w * h,
                    o = l.size || t.height;
                w(l.start) && (a = l.start), t.fullSize ? ss(t, n.left, a, i.outerWidth - n.right - n.left, o) : ss(t, e.left + l.placed, a, s, o), l.start = a, l.placed += s, a = t.bottom
            } else {
                const s = e.h * h,
                    a = l.size || t.width;
                w(l.start) && (o = l.start), t.fullSize ? ss(t, o, n.top, a, i.outerHeight - n.bottom - n.top) : ss(t, o, e.top + l.placed, a, s), l.start = o, l.placed += s, o = t.right
            }
        }
        e.x = o, e.y = a
    }
    var os = {
        ...
        update(t, e, i, s) {
            if (!t) return;
            const n = wi(t.options.layout.padding),
                ...
                r = function(t) {
                    const e = function(t) {
                        ...
                        i = Gi(e.filter((t => t.box.fullSize)), !0),
                        s = Gi(qi(e, "left"), !0),
                        n = Gi(qi(e, "right")),
                        o = Gi(qi(e, "top"), !0),
                        a = Gi(qi(e, "bottom")),
            ...
            const g = Object.assign({
                ...
                p = Zi(l.concat(h), u);
            is(r.fullSize, g, u, p), is(l, g, u, p), is(h, g, u, p) && is(l, g, u, p),
                function(t) {
                ...
                }(g), ns(r.leftAndTop, g, u, p), g.x += g.w, g.y += g.h, ns(r.rightAndBottom, g, u, p), t.chartArea = {
                    left: g.left,
                    top: g.top,
                    right: g.left + g.w,
                    bottom: g.top + g.h,
    ...
    function ds(t, e, i) {
        t.canvas.removeEventListener(e, i, cs)
    }
    ...
    function fs(t, e, i) {
        const s = t.canvas,
            n = new MutationObserver((t => {
                let e = !1;
                for (const i of t) e = e || us(i.addedNodes, s), e = e && !us(i.removedNodes, s);
                e && i()
            }));
    ...
    function gs(t, e, i) {
        const s = t.canvas,
            n = new MutationObserver((t => {
                let e = !1;
                for (const i of t) e = e || us(i.removedNodes, s), e = e && !us(i.addedNodes, s);
                e && i()
            }));
        return n.observe(document, {
            childList: !0,
    ...
    function xs(t, e, i) {
        ...
        return a.observe(n),
            function(t, e) {
                ps.size || window.addEventListener("resize", bs), ps.set(t, e)
            }(t, o), a
    }

    function _s(t, e, i) {
        i && i.disconnect(), "resize" === e && function(t) {
            ps.delete(t), ps.size || window.removeEventListener("resize", bs)
        }(t)
    }
        ...
        acquireContext(t, e) {
            ...
            return i && i.canvas === t ? (function(t, e) {
                ...
                if (t.$chartjs = {
                    ...
                    }, i.display = i.display || "block", i.boxSizing = i.boxSizing || "border-box", hs(n)) {
                    const e = Se(t, "width");
                    void 0 !== e && (t.width = e)
                }
                if (hs(s))
    ...
    function Ms(t) {
        return !fe() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? rs : vs
    }
    ...
    class Ps {
        constructor(t, e, i, s) {
            ...
            this._active = !0, this._fn = t.fn || Ss[t.type || typeof o], this._easing = fi[t.easing] || fi.linear, this._start = Math.floor(Date.now() + (t.delay || 0)), this._duration = this._total = Math.floor(t.duration), this._loop = !!t.loop, this._target = e, this._prop = i, this._from = o, this._to = s, this._promises = void 0
        }
        active() {
            return this._active
        }
        update(t, e, i) {
            if (this._active) {
                ...
                const s = this._target[this._prop],
                    n = i - this._start,
                    o = this._duration - n;
                this._start = i, this._duration = Math.floor(Math.max(o, t.duration)), this._total += n, this._loop = !!t.loop, this._to = Si([t.to, e, s, t.from]), this._from = Si([t.from, s, e])
            }
        }
        cancel() {
    ...
    function Rs(t, e) {
        ...
        for (let t = 0; t < d; ++t) {
            ...
            u = (i._stacks || (i._stacks = {}))[h] = Ls(n, c, o), u[r] = d, u._top = Es(u, a, !0, s.type), u._bottom = Es(u, a, !1, s.type)
        }
    }
    ...
    class Bs {
        ...
        linkScales() {
            const t = this.chart,
                ...
                n = e.xAxisID = r(i.xAxisID, Is(t, "x")),
                o = e.yAxisID = r(i.yAxisID, Is(t, "y")),
                a = e.rAxisID = r(i.rAxisID, Is(t, "r")),
                l = e.indexAxis,
        ...
        _destroy() {
            const t = this._cachedMeta;
            this._data && at(this._data, this), t._stacked && zs(t)
        }
        _dataCheck() {
        ...
        buildOrUpdateElements(t) {
            ...
            this._dataCheck();
            const n = e._stacked;
            e._stacked = Ts(e.vScale, e), e.stack !== i.stack && (s = !0, zs(e), e.stack = i.stack), this._resyncElements(t), (s || n !== e._stacked) && Rs(this, e._parsed)
        }
        configure() {
        ...
        updateRangeFromParsed(t, e, i, s) {
            ...
            s && a && (s.values = a, o = As(s, n, this._cachedMeta.index)), t.min = Math.min(t.min, o), t.max = Math.max(t.max, o)
        }
        getMinMax(t, e) {
        ...
        _resolveAnimations(t, e, i) {
            ...
            const l = new Ds(s, r && r.animations);
    ...
    function Ws(t, e) {
        ...
        if (r > 0) {
            ...
            for (Hs(e, c, d, i(n) ? 0 : l - n, l), t = 0, s = r - 1; t < s; t++) Hs(e, c, d, a[t], a[t + 1]);
            return Hs(e, c, d, h, i(n) ? e.length : h + n), c
        }
        return Hs(e, c, d), c
    }
    ...
    const js = (t, e, i) => "top" === e || "left" === e ? t[e] + i : t[e] - i;
    ...
    class Ks extends Ns {
        ...
        update(t, e, i) {
            ...
            this._convertTicksToLabels(r ? $s(this.ticks, a) : this.ticks), this.configure(), this.beforeCalculateLabelRotation(), this.calculateLabelRotation(), this.afterCalculateLabelRotation(), o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = Ws(this, this.ticks), this._labelSizes = null, this.afterAutoSkip()), r && this._convertTicksToLabels(this.ticks), this.beforeFit(), this.fit(), this.afterFit(), this.afterUpdate()
        }
        configure() {
        ...
        calculateLabelRotation() {
            ...
            o = t.offset ? this.maxWidth / i : u / (i - 1), c + 6 > o && (o = u / (i - (t.offset ? .5 : 1)), a = this.maxHeight - Us(t.grid) - e.padding - Xs(t.title, this.chart.options.font), r = Math.sqrt(c * c + d * d), l = $(Math.min(Math.asin(Z((h.highest.height + 6) / o, -1, 1)), Math.asin(Z(a / r, -1, 1)) - Math.asin(Z(d / r, -1, 1)))), l = Math.max(s, Math.min(n, l))), this.labelRotation = l
        }
            ...
            if (o) {
                ...
                if (a ? (t.width = this.maxWidth, t.height = Us(n) + o) : (t.height = this.maxHeight, t.width = Us(n) + o), i.display && this.ticks.length) {
                    const {
                        ...
                        widest: n,
                        highest: o
                    } = this._getLabelSizes(), r = 2 * i.padding, l = j(this.labelRotation), h = Math.cos(l), c = Math.sin(l);
                    if (a) {
        ...
        _getLabelSizes() {
            ...
            if (!t) {
                ...
                let i = this.ticks;
                e < i.length && (i = $s(i, e)), this._labelSizes = t = this._computeLabelSizes(i, i.length)
            }
            return t
        }
        _computeLabelSizes(t, e) {
            ...
            for (l = 0; l < e; ++l) {
                if (u = t[l].label, f = this._resolveTickFontOptions(l), n.font = g = f.string, p = o[g] = o[g] || {
                    ...
                    if (s(u))
                        for (h = 0, c = u.length; h < c; ++h) _ = u[h], i(_) || s(_) || (b = De(n, p.data, p.gc, b, _), x += m)
                } else b = De(n, p.data, p.gc, b, u), x = m;
        ...
        getPixelForDecimal(t) {
            ...
            return J(this._alignToPixels ? Oe(this.chart, e, 0) : e)
        }
        ...
        getContext(t) {
            ...
            return this.$context || (this.$context = Di(this.chart.getContext(), {
                scale: this,
                type: "scale"
            }))
        }
        ...
        _computeGridLineItems(t) {
            ...
            const A = r(s.ticks.maxTicksLimit, d),
            ...
            for (_ = 0; _ < d; _ += T) {
                ...
                y = Ys(this, _, h), void 0 !== y && (v = Oe(i, y, n), c ? M = k = P = C = v : w = S = D = O = v, f.push({
                    tx1: M,
                    ty1: w,
                    tx2: k,
                    ty2: S,
        ...
        _computeLabelItems(t) {
            const e = this.axis,
                ...
                g = f + d,
                p = u ? -d : g,
                m = -j(this.labelRotation),
                b = [];
            let x, _, y, v, M, w, k, S, P, D, C, O, A = "middle";
            if ("top" === o) w = this.bottom - p, k = this._getXAxisLabelAlignment();
            else if ("bottom" === o) w = this.top + p, k = this._getXAxisLabelAlignment();
            else if ("left" === o) {
                ...
                if ("center" === o) w = (t.top + t.bottom) / 2 + g;
                else if (n(o)) {
                ...
                if ("center" === o) M = (t.left + t.right) / 2 - g;
                else if (n(o)) {
                    const t = Object.keys(o)[0],
                        e = o[t];
            ...
            for (x = 0, _ = l.length; x < _; ++x) {
                ...
                S = this.getPixelForTick(x) + a.labelOffset, P = this._resolveTickFontOptions(x), D = P.lineHeight, C = s(v) ? v.length : 1;
                const e = C / 2,
                    i = t.color,
                    n = t.textStrokeColor,
                    h = t.textStrokeWidth;
                let d, f = k;
                if (r ? (M = S, "inner" === k && (f = x === _ - 1 ? this.options.reverse ? "left" : "right" : 0 === x ? this.options.reverse ? "right" : "left" : "center"), O = "top" === o ? "near" === c || 0 !== m ? -C * D + D / 2 : "center" === c ? -T.highest.height / 2 - e * D + D : -T.highest.height + D / 2 : "near" === c || 0 !== m ? D / 2 : "center" === c ? T.highest.height / 2 - e * D : T.highest.height - C * D, u && (O *= -1), 0 === m || t.showLabelBackdrop || (M += D / 2 * Math.sin(m))) : (w = S, O = (1 - C) * D / 2), t.showLabelBackdrop) {
                    const e = wi(t.backdropPadding),
                        i = T.heights[x],
                        s = T.widths[x];
                    let n = O - e.top,
                        o = 0 - e.left;
        ...
        drawLabels(t) {
            ...
            for (n = 0, o = s.length; n < o; ++n) {
                const t = s[n],
                    i = t.font;
                Ve(e, t.label, 0, t.textOffset, i, t)
            }
            i && Ie(e)
        }
        drawTitle() {
            ...
            const {
                ...
                if (t.isHorizontal()) {
                    ...
                    } else g = "center" === i ? (c.bottom + c.top) / 2 + m - e : js(t, i, e);
                    u = l - a
                } else {
                    if (n(i)) {
                        const t = Object.keys(i)[0],
                    ...
                    } else f = "center" === i ? (c.left + c.right) / 2 - b + e : js(t, i, e);
        ...
        _resolveTickFontOptions(t) {
            return ki(this.options.ticks.setContext(this.getContext(t)).font)
        }
        _maxDigits() {
    ...
    class Gs {
        ...
        register(t) {
            ...
            return n in s || (s[n] = t, function(t, e, i) {
                const s = m(Object.create(null), [i ? ue.get(i) : {}, ue.get(e), t.defaults]);
    ...
    class Zs {
        constructor() {
            this.controllers = new Gs(Bs, "datasets", !0), this.elements = new Gs(Ns, "elements"), this.plugins = new Gs(Object, "plugins"), this.scales = new Gs(Ks, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
        }
        add(...t) {
    ...
    class dn {
            ...
            if (function(t, e) {
                    ...
                    for (const o of e) {
                        const e = i(o),
                            a = n(o),
                            r = (a || e) && t[o];
                        if (e && (k(r) || fn(r)) || a && s(r)) return !0
                    }
                    return !1
                }(a, e)) {
                o.$shared = !1;
                l = je(a, i = k(i) ? i() : i, this.createResolver(t, i, r))
            }
        ...
        createResolver(t, e, i = [""], s) {
            const {
                resolver: o
            } = un(this._resolverCache, t, i);
            return n(e) ? je(o, e, void 0, s) : o
        }
    }
    ...
    const fn = t => n(t) && Object.getOwnPropertyNames(t).reduce(((e, i) => e || k(t[i])), !1);
    ...
    class wn {
        ...
        buildOrUpdateScales() {
            ...
            e && (n = n.concat(Object.keys(e).map((t => {
                ...
                os.configure(this, t, t.options), os.addBox(this, t)
            }))
        }
        _updateMetasets() {
        ...
        buildOrUpdateControllers() {
            ...
            for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
                ...
                if (n.type && n.type !== o && (this._destroyDatasetMeta(i), n = this.getDatasetMeta(i)), n.type = o, n.indexAxis = s.indexAxis || sn(o, this.options), n.order = s.order || 0, n.index = i, n.label = "" + s.label, n.visible = this.isDatasetVisible(i), n.controller) n.controller.updateIndex(i), n.controller.linkScales();
                else {
        ...
        _updateLayout(t) {
            ...
            os.update(this, this.width, this.height, t);
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", {
                cancelable: !0
            }) && (bt.has(this) ? this.attached && !bt.running(this) && bt.start(this) : (this.draw(), bn({
                chart: this
            })))
        }
        draw() {
        ...
        _drawDataset(t) {
            ...
            }), t.controller.draw(), s && Ie(e), o.cancelable = !1, this.notifyPlugins("afterDatasetDraw", o))
        }
        isPointInArea(t) {
    ...
    function kn() {
        return d(wn.instances, (t => t._plugins.invalidate()))
    }
    var Sn = wn;
    ...
    function Tn(t, e, i, s) {
        const n = t.iScale,
            ...
            l = [];
        let h, c, d, u;
        for (h = i, c = i + s; h < c; ++h) u = e[h], d = {}, d[n.axis] = r || n.parse(a[h], h), l.push(An(u, d, o, h));
        return l
    }
    ...
    function En(t, e, i, s) {
        ...
        "middle" === n && i && (t.enableBorderRadius = !0, (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[Rn(c, a, r, l)] = !0, n = h)), o[Rn(n, a, r, l)] = !0, t.borderSkipped = o
    }

    function Rn(t, e, i, s) {
        var n, o, a;
        return s ? (a = i, t = In(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = In(t, e, i), t
    }
    ...
    class Fn extends Bs {
        ...
        _circumference(t, e) {
            ...
            return e && i.animation.animateRotate || !this.chart.getDataVisibility(t) || null === s._parsed[t] || s.data[t].hidden ? 0 : this.calculateCircumference(s._parsed[t] * n / C)
        }
        updateElements(t, e, i, s) {
            const n = "reset" === s,
                o = this.chart,
    ...
    var Vn = Object.freeze({
        ...
        BarController: class extends Bs {
            ...
            parseObjectData(t, e, i, s) {
                ...
                let d, u, f, g;
                for (d = i, u = i + s; d < u; ++d) g = e[d], f = {}, f[n.axis] = n.parse(v(g, l), d), c.push(An(v(g, h), f, o, d));
                return c
            }
            updateRangeFromParsed(t, e, i, s) {
            ...
            getLabelAndValue(t) {
                const e = this._cachedMeta,
                    ...
                    n = this.getParsed(t),
                    o = n._custom,
                    a = Ln(o) ? "[" + o.start + ", " + o.end + "]" : "" + s.getLabelForValue(n[s.axis]);
                return {
                ...
                for (let f = e; f < e + s; f++) {
                    const e = this.getParsed(f),
                        ...
                        m = {
                            horizontal: h,
                            base: s.base,
                            enableBorderRadius: !p || Ln(e._custom) || a === p._top || a === p._bottom,
                            x: h ? s.head : g.center,
                            y: h ? g.center : s.head,
                    ...
                    En(m, b, p, a), zn(m, b, c.ratio), this.updateElement(t[f], f, m, n)
                }
            }
            _getStacks(t, e) {
                const {
            ...
            _calculateBarValuePixels(t) {
                ...
                } = this, a = n || 0, r = this.getParsed(t), l = r._custom, h = Ln(l);
                let c, d, u = r[e.axis],
                    f = 0,
        ...
        LineController: class extends Bs {
            ...
            updateElements(t, e, s, n) {
                ...
                for (let s = 0; s < _; ++s) {
                    ...
                    const v = this.getParsed(s),
                        M = i(v[f]),
                        w = _[u] = a.getPixelForValue(v[u], s),
                        k = _[f] = o || M ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, v, l) : v[f], s);
                    _.skip = isNaN(w) || isNaN(k) || M, _.stop = s > 0 && Math.abs(v[u] - y[u]) > m, p && (_.parsed = v, _.raw = h.data[s]), d && (_.options = c || this.resolveDataElementOptions(s, g.active ? "active" : n)), b || this.updateElement(g, s, _, n), y = v
                }
            }
            getMaxOverflow() {
                const t = this._cachedMeta,
        ...
        PolarAreaController: class extends Bs {
            static id = "polarArea";
            static defaults = {
                dataElementType: "arc",
                animation: {
        ...
        PieController: class extends Fn {
            static id = "pie";
            static defaults = {
                cutout: 0,
                rotation: 0,
            ...
            updateElements(t, e, s, n) {
                ...
                for (let c = e; c < e + s; ++c) {
                    const e = t[c],
                        ...
                        M = p[g] = o || y ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, s, l) : s[g], c);
                    p.skip = isNaN(v) || isNaN(M) || y, p.stop = c > 0 && Math.abs(s[f] - _[f]) > b, m && (p.parsed = s, p.raw = h.data[c]), u && (p.options = d || this.resolveDataElementOptions(c, e.active ? "active" : n)), x || this.updateElement(e, c, p, n), _ = s
                }
    ...
    function Bn(t, e, i, s) {
        const n = yi(t.options.borderRadius, ["outerStart", "outerEnd", "innerStart", "innerEnd"]);
        const o = (i - e) / 2,
            a = Math.min(o, s * e / 2),
            r = t => {
    ...
    function Hn(t, e, i, s, n) {
        ...
        }(t, e, u), o || (Wn(t, e, i, s, u, n), t.stroke())
    }
    ...
    function Gn(t, e, i, s) {
        Kn && !e.options.segment ? function(t, e, i, s) {
            ...
            for (const r of n) jn(t, o, r.style), t.beginPath(), a(t, e, r, {
                start: i,
                end: i + s - 1
    ...
    class Zn extends Ns {
        ...
        get segments() {
            return this._segments || (this._segments = Ii(this, this.options.segment))
        }
        first() {
    ...
    function eo(t) {
        const e = Qn(t),
            ...
            a = function(t, e, i) {
                ...
                } = t.getProps(["enableBorderRadius"]), o = t.options.borderRadius, a = Mi(o), r = Math.min(e, i), l = t.borderSkipped, h = s || n(o);
                return {
    ...
    var oo = Object.freeze({
        ...
        ArcElement: class extends Ns {
            ...
            draw(t) {
                ...
                if (this.pixelMargin = "inner" === e.borderAlign ? .33 : 0, this.fullCircles = i > C ? Math.floor(i / C) : 0, 0 === i || this.innerRadius < 0 || this.outerRadius < 0) return;
                t.save();
                const a = (this.startAngle + this.endAngle) / 2;
                t.translate(Math.cos(a) * s, Math.sin(a) * s);
                const r = s * (1 - Math.sin(Math.min(D, i || 0)));
                t.fillStyle = e.backgroundColor, t.strokeStyle = e.borderColor,
                    ...
                    }(t, this, r, n, o), Hn(t, this, r, n, o), t.restore()
            }
        },
        LineElement: Zn,
        PointElement: class extends Ns {
            static id = "point";
            static defaults = {
                borderWidth: 1,
                hitRadius: 1,
        ...
        BarElement: class extends Ns {
            ...
            draw(t) {
                const {
                    ...
                    inner: n,
                    outer: o
                } = eo(this), a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? We : so;
                var r;
    ...
    const ao = ["rgb(54, 162, 235)", "rgb(255, 99, 132)", "rgb(255, 159, 64)", "rgb(255, 205, 86)", "rgb(75, 192, 192)", "rgb(153, 102, 255)", "rgb(201, 203, 207)"],
        ro = ao.map((t => t.replace("rgb(", "rgba(").replace(")", ", 0.5)")));
    ...
    function co(t) {
        return "doughnut" === t || "pie" === t ? function() {
            let t = 0;
            return e => {
                e.backgroundColor = e.data.map((() => lo(t++)))
            }
        }() : "polarArea" === t ? function() {
            let t = 0;
            return e => {
                e.backgroundColor = e.data.map((() => ho(t++)))
            }
        }() : (t, e) => {
            t.borderColor = lo(e), t.backgroundColor = ho(e)
        }
    }
    ...
    var mo = {
        ...
        beforeElementsUpdate: (t, e, s) => {
            ...
            t.data.datasets.forEach(((e, o) => {
                ...
                if ("y" === Si([r, t.options.indexAxis])) return;
                ...
                if (u <= (s.threshold || 4 * n)) return void go(e);
                let f;
    ...
    function Do(t) {
        ...
        if ("stack" === i) return function(t) {
            ...
            for (let t = 0; t < o.length; t++) {
                const e = o[t];
                for (let t = e.start; t <= e.end; t++) ko(n, a[t], r)
            }
            return new Zn({
                points: n,
                options: {}
        ...
        return a instanceof Po ? a : yo(a, s)
    }
    ...
    function Co(t, e, i) {
        ...
        s && n.points.length && (Re(t, i), function(t, e) {
            const {
                line: i,
                target: s,
                above: n,
            ...
            t.save(), "x" === l && o !== n && (Oo(t, s, a.top), Ao(t, {
                line: i,
                target: s,
                color: n,
                scale: r,
                property: l
            }), t.restore(), t.save(), Oo(t, s, a.bottom));
            Ao(t, {
                line: i,
                target: s,
                color: o,
    ...
    function Ao(t, e) {
            ...
            for (const t of s) {
                ...
                for (const e of h) {
                    ...
                    for (const t of r) a.push({
                        ...
                        target: e,
                        start: {
                            [i]: _o(l, s, "start", Math.max)
                        },
                        end: {
                            [i]: _o(l, s, "end", Math.min)
                        }
                    })
                }
            }
        ...
        for (const {
            ...
            t.save(), t.fillStyle = r, To(t, a, d && bo(n, h, c)), t.beginPath();
            const u = !!i.pathSegment(t, e);
            let f;
            if (d) {
                u ? t.closePath() : Lo(t, s, c, n);
    ...
    var Eo = {
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < s; ++a) l = n[a], l && !1 !== l.fill && (l.fill = Mo(n, a, i.propagate))
        },
        beforeDraw(t, e, i) {
            ...
            for (let e = n.length - 1; e >= 0; --e) {
                const i = n[e].$filler;
                i && (i.line.updateControlPoints(o, i.axis), s && i.fill && Co(t.ctx, i, o))
            }
        },
        beforeDatasetsDraw(t, e, i) {
            ...
            for (let e = s.length - 1; e >= 0; --e) {
                const i = s[e].$filler;
                vo(i) && Co(t.ctx, i, t.chartArea)
            }
        },
        beforeDatasetDraw(t, e, i) {
            const s = e.meta.$filler;
            vo(s) && "beforeDatasetDraw" === i.drawTime && Co(t.ctx, s, t.chartArea)
        },
        defaults: {
            propagate: !0,
    ...
    class Io extends Ns {
        ...
        _draw() {
            const {
                ...
                align: n,
                labels: o
            } = t, a = ue.color, l = Ci(t.rtl, this.left, this.width), h = ki(o.font), {
                padding: c
            } = o, d = h.size, u = d / 2;
            let f;
            ...
            const {
                ...
                boxHeight: p,
                itemHeight: m
            } = Ro(o, d), b = this.isHorizontal(), x = this._computeTitleHeight();
            f = b ? {
                ...
                x: this.left + c,
                y: ut(n, this.top + x + c, this.bottom - e[0].height),
                line: 0
            ...
            this.legendItems.forEach(((y, v) => {
                ...
                let S = f.x,
                    P = f.y;
                l.setWidth(this.width), b ? v > 0 && S + k + c > this.right && (P = f.y += _, f.line++, S = f.x = ut(n, this.left + c, this.right - i[f.line])) : v > 0 && P + _ > this.bottom && (S = f.x = S + e[f.line].width + c, f.line++, P = f.y = ut(n, this.top + x + c, this.bottom - e[f.line].height));
                if (function(t, e, i) {
                        ...
                        if (s.fillStyle = r(i.fillStyle, a), s.lineCap = r(i.lineCap, "butt"), s.lineDashOffset = r(i.lineDashOffset, 0), s.lineJoin = r(i.lineJoin, "miter"), s.lineWidth = n, s.strokeStyle = r(i.strokeStyle, a), s.setLineDash(r(i.lineDash, [])), o.usePointStyle) {
                            const a = {
                                ...
                                r = l.xPlus(t, g / 2);
                            Le(s, a, r, e + u, o.pointStyleWidth && g)
                        } else {
                            const o = e + Math.max((d - p) / 2, 0),
                                a = l.leftForLtr(t, g),
                                r = Mi(i.borderRadius);
                            s.beginPath(), Object.values(r).some((t => 0 !== t)) ? We(s, {
                                x: a,
                                y: o,
                                w: g,
                                h: p,
                        ...
                        s.restore()
                    }(l.x(S), P, y), S = ft(w, S + g + u, b ? S + k : this.right, t.rtl), function(t, e, i) {
        ...
        drawTitle() {
            const t = this.options,
                ...
                s = wi(e.padding);
            if (!e.display) return;
            const n = Ci(t.rtl, this.left, this.width),
                o = this.ctx,
                a = e.position,
                r = i.size / 2,
                l = s.top + r;
            ...
            const u = ut(a, c, c + d);
            o.textAlign = n.textAlign(dt(a)), o.textBaseline = "middle", o.strokeStyle = e.color, o.fillStyle = e.color, o.font = i.string, Ve(o, e.text, u, h, i)
        }
        _computeTitleHeight() {
    ...
    var Fo = {
        ...
        _element: Io,
        start(t, e, i) {
            const s = t.legend = new Io({
                ctx: t.ctx,
                options: i,
                chart: t
            });
            os.configure(t, s, i), os.addBox(t, s)
        },
        stop(t) {
            os.removeBox(t, t.legend), delete t.legend
        },
        beforeUpdate(t, e, i) {
            const s = t.legend;
            os.configure(t, s, i), s.options = i
        },
        afterUpdate(t) {
            const e = t.legend;
    ...
    class Vo extends Ns {
        ...
        update(t, e) {
            ...
            this._padding = wi(i.padding);
            const o = n * ki(i.font).lineHeight + this._padding.height;
    ...
    var Bo = {
        ...
        start(t, e, i) {
            ! function(t, e) {
                ...
                os.configure(t, i, e), os.addBox(t, i), t.titleBlock = i
            }(t, i)
        },
        stop(t) {
            const e = t.titleBlock;
            os.removeBox(t, e), delete t.titleBlock
        },
        beforeUpdate(t, e, i) {
    ...
    var Wo = {
        ...
        start(t, e, i) {
            ...
            os.configure(t, s, i), os.addBox(t, s), No.set(t, s)
        },
        stop(t) {
            os.removeBox(t, No.get(t)), No.delete(t)
        },
        beforeUpdate(t, e, i) {
            const s = No.get(t);
            os.configure(t, s, i), s.options = i
    ...
    function qo(t, e, i) {
        ...
        return {
            xAlign: i.xAlign || e.xAlign || Xo(t, e, i, s),
            yAlign: s
        }
    }
    ...
    function ta(t, e, i, s) {
        ...
        return void 0 === n ? Qo[e].call(i, s) : n
    }
    class ea extends Ns {
        static positioners = Ho;
        constructor(t) {
        ...
        _resolveAnimations() {
            ...
            const e = this.chart,
                ...
                n = new Ds(this.chart, s);
            return s._cacheable && (this._cachedAnimations = Object.freeze(n)), n
        }
        getContext() {
            return this.$context || (this.$context = (t = this.chart.getContext(), e = this, i = this._tooltipItems, Di(t, {
                tooltip: e,
                tooltipItems: i,
                type: "tooltip"
            })));
        ...
        getTitle(t, e) {
            const {
                callbacks: i
            } = e, s = ta(i, "beforeTitle", this, t), n = ta(i, "title", this, t), o = ta(i, "afterTitle", this, t);
            let a = [];
            return a = jo(a, $o(s)), a = jo(a, $o(n)), a = jo(a, $o(o)), a
        }
        getBeforeBody(t, e) {
            return Zo(ta(e.callbacks, "beforeBody", this, t))
        }
        getBody(t, e) {
            const {
                callbacks: i
            ...
            return d(t, (t => {
                const e = {
                    ...
                    n = Jo(i, t);
                jo(e.before, $o(ta(n, "beforeLabel", this, t))), jo(e.lines, ta(n, "label", this, t)), jo(e.after, $o(ta(n, "afterLabel", this, t))), s.push(e)
            })), s
        }
        getAfterBody(t, e) {
            return Zo(ta(e.callbacks, "afterBody", this, t))
        }
        getFooter(t, e) {
            const {
                callbacks: i
            } = e, s = ta(i, "beforeFooter", this, t), n = ta(i, "footer", this, t), o = ta(i, "afterFooter", this, t);
            let a = [];
            return a = jo(a, $o(s)), a = jo(a, $o(n)), a = jo(a, $o(o)), a
        }
        _createItems(t) {
            const e = this._active,
                ...
                o = [];
            let a, r, l = [];
            for (a = 0, r = e.length; a < r; ++a) l.push(Yo(this.chart, e[a]));
            return t.filter && (l = l.filter(((e, s, n) => t.filter(e, s, n, i)))), t.itemSort && (l = l.sort(((e, s) => t.itemSort(e, s, i)))), d(l, (e => {
                const i = Jo(t.callbacks, e);
                s.push(ta(i, "labelColor", this, e)), n.push(ta(i, "labelPointStyle", this, e)), o.push(ta(i, "labelTextColor", this, e))
        ...
        update(t, e) {
            ...
            let n, o = [];
            if (s.length) {
                const t = Ho[i.position].call(this, s, this._eventPosition);
                o = this._createItems(i), this.title = this.getTitle(o, i), this.beforeBody = this.getBeforeBody(o, i), this.body = this.getBody(o, i), this.afterBody = this.getAfterBody(o, i), this.footer = this.getFooter(o, i);
                const e = this._size = Uo(this, i),
                    a = Object.assign({}, t, e),
                    r = qo(this.chart, i, a),
                    l = Ko(i, a, r, this.chart);
        ...
        drawTitle(t, e, i) {
            ...
            let o, a, r;
            if (n) {
                const l = Ci(i.rtl, this.x, this.width);
                for (t.x = Go(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = ki(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r) e.fillText(s[r], l.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + a, r + 1 === n && (t.y += i.titleMarginBottom - a)
            }
        }
        _drawColorBox(t, e, i, s, o) {
            ...
            if (o.usePointStyle) {
                const e = {
                    ...
                    n = p + l / 2;
                t.strokeStyle = o.multiKeyBackground, t.fillStyle = o.multiKeyBackground, Te(t, e, i, n), t.strokeStyle = a.borderColor, t.fillStyle = a.backgroundColor, Te(t, e, i, n)
            } else {
                ...
                const e = s.leftForLtr(f, h - c),
                    ...
                    r = Mi(a.borderRadius);
                Object.values(r).some((t => 0 !== t)) ? (t.beginPath(), t.fillStyle = o.multiKeyBackground, We(t, {
                    x: e,
                    y: p,
                    w: h,
                    h: l,
        ...
        drawBody(t, e, i) {
            ...
            let u = c.lineHeight,
                f = 0;
            const g = Ci(i.rtl, this.x, this.width),
                p = function(i) {
                    e.fillText(i, g.x(t.x + f), t.y + u / 2), t.y += u + n
                },
                m = g.textAlign(o);
            let b, x, _, y, v, M, w;
            for (e.textAlign = o, e.textBaseline = "middle", e.font = c.string, t.x = Go(this, m, i), e.fillStyle = i.bodyColor, d(this.beforeBody, p), f = a && "right" !== m ? "center" === o ? l / 2 + h : l + 2 + h : 0, y = 0, M = s.length; y < M; ++y) {
                for (b = s[y], x = this.labelTextColors[y], e.fillStyle = x, d(b.before, p), _ = b.lines, a && _.length && (this._drawColorBox(e, t, y, g, i), u = Math.max(c.lineHeight, r)), v = 0, w = _.length; v < w; ++v) p(_[v]), u = c.lineHeight;
                d(b.after, p)
            }
        ...
        drawFooter(t, e, i) {
            ...
            let o, a;
            if (n) {
                const r = Ci(i.rtl, this.x, this.width);
                for (t.x = Go(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = ki(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a) e.fillText(s[a], r.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + i.footerSpacing
            }
        }
        ...
        _updateAnimationTarget(t) {
            const e = this.chart,
                ...
                n = i && i.y;
            if (s || n) {
                const i = Ho[t.position].call(this, this._active, this._eventPosition);
                if (!i) return;
                const o = this._size = Uo(this, t),
        ...
        _positionChanged(t, e) {
            const {
                ...
                caretY: s,
                options: n
            } = this, o = Ho[n.position].call(this, t, e);
        ...
        buildTicks() {
            ...
            const n = function(t, e) {
                const s = [],
                    ...
                    _ = !i(h),
                    y = (m - p) / (d + 1);
                let v, M, w, k, S = V((m - p) / g / f) * f;
                if (S < 1e-14 && !b && !x) return [{
                    value: p
                }, {
                    value: m
                }];
                k = Math.ceil(m / S) - Math.floor(p / S), k > g && (S = V(k * S / g / f) * f), i(l) || (v = Math.pow(10, l), S = Math.ceil(S * v) / v), "ticks" === n ? (M = Math.floor(p / S) * S, w = Math.ceil(m / S) * S) : (M = p, w = m), b && x && o && W((r - a) / o, S / 1e3) ? (k = Math.round(Math.min((r - a) / S, c)), S = (r - a) / k, M = a, w = r) : _ ? (M = b ? a : M, w = x ? r : w, k = h - 1, S = (w - M) / k) : (k = (w - M) / S, k = F(k, Math.round(k), S / 1e3) ? Math.round(k) : Math.ceil(k));
                const P = Math.max(Y(S), Y(M));
                v = Math.pow(10, i(l) ? P : l), M = Math.round(M * v) / v, w = Math.round(w * v) / v;
                let D = 0;
                for (b && (u && M !== a ? (s.push({
                        value: a
                    }), M < a && D++, F(Math.round((M + D * S) * v) / v, a, aa(a, y, t)) && D++) : M < a && D++); D < k; ++D) s.push({
                    value: Math.round((M + D * S) * v) / v
                });
                return x && u && w !== r ? s.length && F(s[s.length - 1].value, r, aa(r, y, t)) ? s[s.length - 1].value = r : s.push({
                    value: r
                }) : x && w !== r || s.push({
                    value: w
                }), s
    ...
    const ha = t => Math.floor(I(t)),
        ca = (t, e) => Math.pow(10, ha(t) + e);

    function da(t) {
        return 1 === t / Math.pow(10, ha(t))
    }
    ...
    function fa(t, {
        ...
        let u = Math.floor((c - d) / Math.pow(10, o)),
            f = a(t.min, Math.round((h + d + u * Math.pow(10, o)) * r) / r);
        for (; f < i;) s.push({
            value: f,
            major: da(f),
            significand: u
        }), u >= 10 ? u = u < 15 ? 15 : 20 : u++, u >= 20 && (o++, u = 2, r = o >= 0 ? 1 : r), f = Math.round((h + d + u * Math.pow(10, o)) * r) / r;
        const g = a(t.max, f);
        return s.push({
            value: g,
            major: da(g),
    ...
    class ga extends Ks {
        ...
        determineDataLimits() {
            ...
            this.min = o(t) ? Math.max(0, t) : null, this.max = o(e) ? Math.max(0, e) : null, this.options.beginAtZero && (this._zero = !0), this._zero && this.min !== this._suggestedMin && !o(this._userMin) && (this.min = t === ca(this.min, 0) ? ca(this.min, -1) : ca(this.min, 0)), this.handleTickRangeOptions()
        }
        handleTickRangeOptions() {
            const {
                minDefined: t,
            ...
            const n = e => i = t ? i : e,
                o = t => s = e ? s : t;
            i === s && (i <= 0 ? (n(1), o(10)) : (n(ca(i, -1)), o(ca(s, 1)))), i <= 0 && n(ca(s, -1)), s <= 0 && o(ca(i, 1)), this.min = i, this.max = s
        }
        buildTicks() {
            const t = this.options,
                e = fa({
    ...
    function pa(t) {
        ...
        if (e.display && t.display) {
            const t = wi(e.backdropPadding);
            return r(e.font && e.font.size, ue.font.size) + t.height
        }
        return 0
    }
    ...
    function ba(t) {
        ...
        for (let u = 0; u < a; u++) {
            ...
            const m = K(t.getIndexAngle(u) + l),
                b = Math.round($(m));
            xa(i, e, m, ma(b, f.x, p.w, 0, 180), ma(b, f.y, p.h, 90, 270))
        }
        var h, c, d;
    ...
    function Ma(t, e, i, s) {
        ...
        if (i) n.arc(t.xCenter, t.yCenter, e, 0, C);
        else {
    ...
    class wa extends ra {
        ...
        setDimensions() {
            const t = this._padding = wi(pa(this.options) / 2),
        ...
        generateTickLabels(t) {
            ra.prototype.generateTickLabels.call(this, t), this._pointLabels = this.getLabels().map(((t, e) => {
        ...
        fit() {
            const t = this.options;
            t.display && t.pointLabels.display ? ba(this) : this.setCenterPoint(0, 0, 0, 0)
        }
        ...
        getIndexAngle(t) {
            return K(t * (C / (this._pointLabels.length || 1)) + j(this.options.startAngle || 0))
        }
        ...
        drawBackground() {
            ...
            if (t) {
                const i = this.ctx;
                i.save(), i.beginPath(), Ma(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length), i.closePath(), i.fillStyle = t, i.fill(), i.restore()
            }
        }
        drawGrid() {
            const t = this.ctx,
            ...
            if (e.pointLabels.display && function(t, e) {
                    ...
                    for (let o = e - 1; o >= 0; o--) {
                        ...
                        if (!i(g)) {
                            const t = Mi(e.borderRadius),
                                i = wi(e.backdropPadding);
                            s.fillStyle = g;
                            const n = c - i.left,
                                o = d - i.top,
                                a = u - c + i.width,
                                r = f - d + i.height;
                            Object.values(t).some((t => 0 !== t)) ? (s.beginPath(), We(s, {
                                x: n,
                                y: o,
                                w: a,
                                h: r,
                        ...
                        Ve(s, t._pointLabels[o], r, l + a.lineHeight / 2, a, {
                            color: e.color,
                            textAlign: h,
                            textBaseline: "middle"
                        })
                    }
                }(this, a), n.display && this.ticks.forEach(((t, e) => {
                    if (0 !== e) {
                        ...
                        ! function(t, e, i, s, n) {
                            ...
                            !a && !s || !r || !l || i < 0 || (o.save(), o.strokeStyle = r, o.lineWidth = l, o.setLineDash(n.dash), o.lineDashOffset = n.dashOffset, o.beginPath(), Ma(t, i, a, s), o.closePath(), o.stroke(), o.restore())
                        }(this, s, l, a, r)
                    }
                })), s.display) {
                for (t.save(), r = a - 1; r >= 0; r--) {
                    ...
                    o && n && (t.lineWidth = o, t.strokeStyle = n, t.setLineDash(i.borderDash), t.lineDashOffset = i.borderDashOffset, l = this.getDistanceFromCenterForValue(e.ticks.reverse ? this.min : this.max), h = this.getPointPosition(r, l), t.beginPath(), t.moveTo(this.xCenter, this.yCenter), t.lineTo(h.x, h.y), t.stroke())
                }
                t.restore()
            }
        }
    ...
    function Da(t, e) {
        ...
        let l = e;
        return "function" == typeof n && (l = n(l)), o(l) || (l = "string" == typeof n ? s.parse(l, n) : s.parse(l)), null === l ? null : (a && (l = "week" !== a || !N(r) && !0 !== r ? s.startOf(l, a) : s.startOf(l, "isoWeek", r)), +l)
    }

    function Ca(t, e, i, s) {
        const n = Sa.length;
        for (let o = Sa.indexOf(t); o < n - 1; ++o) {
            const t = ka[Sa[o]],
                n = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
            if (t.common && Math.ceil((i - e) / (n * t.size)) <= s) return Sa[o]
        }
        return Sa[n - 1]
    }
    ...
    class Ta extends Ks {
        ...
        init(t, e = {}) {
            const i = t.time || (t.time = {}),
                s = this._adapter = new Cn._date(t.adapters.date);
        ...
        parse(t, e) {
            return void 0 === t ? null : Da(this, t)
        }
        beforeLayout() {
        ...
        buildTicks() {
            ...
            const n = this.min,
                o = st(s, n, this.max);
            return this._unit = e.unit || (i.autoSkip ? Ca(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function(t, e, i, s, n) {
                for (let o = Sa.length - 1; o >= Sa.indexOf(i); o--) {
                    const i = Sa[o];
                    if (ka[i].common && t._adapter.diff(n, s, i) >= e - 1) return i
                }
                return Sa[i ? Sa.indexOf(i) : 0]
            }(this, o.length, e.minUnit, this.min, this.max)), this._majorUnit = i.major.enabled && "year" !== this._unit ? function(t) {
                for (let e = Sa.indexOf(t) + 1, i = Sa.length; e < i; ++e)
                    if (ka[Sa[e]].common) return Sa[e]
            }(this._unit) : void 0, this.initOffsets(s), t.reverse && o.reverse(), Aa(this, o, this._majorUnit)
        }
        afterAutoSkip() {
        ...
        _generate() {
            const t = this._adapter,
                ...
                s = this.options,
                n = s.time,
                o = n.unit || Ca(n.minUnit, e, i, this._getLabelCapacity(e)),
            ...
            for (d = f, u = 0; d < i; d = +t.add(d, a, o), u++) Oa(c, d, g);
            return d !== i && "ticks" !== s.bounds && 1 !== u || Oa(c, d, g), Object.keys(c).sort(((t, e) => t - e)).map((t => +t))
        }
        getLabelForValue(t) {
        ...
        _getLabelCapacity(t) {
            const e = this.options.time,
                ...
                n = this._tickFormatFunction(t, 0, Aa(this, [t], this._majorUnit), s),
        ...
        getLabelTimestamps() {
            ...
            for (e = 0, i = s.length; e < i; ++e) t.push(Da(this, s[e]));
    ...
    var Ea = class extends Ta {
            ...
            initOffsets() {
                ...
                this._minPos = La(e, this.min), this._tableRange = La(e, this.max) - this._minPos, super.initOffsets(t)
            }
            buildLookupTable(t) {
                const {
                    min: e,
        ...
        Ra = Object.freeze({
            ...
            CategoryScale: class extends Ks {
                ...
                parse(t, e) {
                    if (i(t)) return null;
                    const s = this.getLabels();
                    return ((t, e) => null === t ? null : Z(Math.round(t), 0, e))(e = isFinite(e) && s[e] === t ? e : na(s, t, r(e, t), this._addedLabels), s.length - 1)
                }
                determineDataLimits() {
                    const {
                        minDefined: t,
            ...
            LinearScale: la,
            LogarithmicScale: ga,
            RadialLinearScale: wa,
            TimeScale: Ta,
            TimeSeriesScale: Ea
        });
    return Sn.register(Vn, Ra, oo, sa), Sn.helpers = { ...Bi
