(function($) {
    ...
    $.fn.menumaker = function(rs_options) {
        var rs_elementor_responsive_menu = $(this),
            settings = $.extend({
                format: "dropdown",
                sticky: false
            }, rs_options);
        ...
        return this.each(function() {
            rs_elementor_responsive_menu.find('li ul').parent().addClass('has-sub');
            ...
            var resizeFix = function() {
                if ($(window).width() > 1024) {
                    rs_elementor_responsive_menu.find('ul').show('fadeIn');
                    rs_elementor_responsive_menu.find('ul.sub-menu').hide('fadeIn');
                }
            };
            resizeFix();
